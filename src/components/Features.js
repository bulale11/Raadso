      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">All our properties are verified and regularly inspected to ensure quality and safety.</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">We offer competitive prices with no hidden fees or charges.</p>
          </div>
