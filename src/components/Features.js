      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          <div className="text-center">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">Verified Properties</h3>
            <p className="text-sm sm:text-base text-gray-600">All our properties are verified and regularly inspected to ensure quality and safety.</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">Best Prices</h3>
            <p className="text-sm sm:text-base text-gray-600">We offer competitive prices with no hidden fees or charges.</p>
          </div>
