...
const DownloadSection = () => {
  return (
    <section id="download" className="py-12 sm:py-16 bg-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
          {/* iOS Download */}
          <div className="bg-white p-6 sm:p-8 rounded-lg shadow-lg text-center border border-gray-200">
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">iOS</h3>
          ...
          <div className="bg-white p-6 sm:p-8 rounded-lg shadow-lg text-center border border-gray-200">
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">Android</h3>
            <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">
